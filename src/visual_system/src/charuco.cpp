...
int main(int argc, char** argv)
{
  ...
  message_filters::Subscriber<sensor_msgs::Image> image_sub(pnh, "/zed/zed_node/rgb/image_rect_color", 1);
  message_filters::Subscriber<sensor_msgs::CameraInfo> info_sub(pnh, "/zed/zed_node/rgb/camera_info", 1);
